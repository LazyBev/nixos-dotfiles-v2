...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_b,              spawn,            SHCMD("qutebrowser") },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_b,              spawn,            SHCMD("librewolf") },
	{ MODKEY,                    XKB_KEY_t,              spawn,            SHCMD("alacritty -e yazi") },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_t,              spawn,            SHCMD("thunar") },
	{ MODKEY,                    XKB_KEY_e,              spawn,            SHCMD("alacritty -e nvim") },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_e,              spawn,            SHCMD("vscodium") },
	{ MODKEY,                    XKB_KEY_s,              spawn,            SHCMD("alacritty -e rmpc") },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_w,              spawn,            SHCMD("steam") },
	{ MODKEY,                    XKB_KEY_v,              spawn,            SHCMD("alacritty -e btop") },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_v,              spawn,            SHCMD("vesktop") },
	{ MODKEY,                    XKB_KEY_d,              spawn,            SHCMD("wmenu-run") },
	{ MODKEY,                    XKB_KEY_y,              spawn,            SHCMD("waypaper") },

	/* Session / system */
	{ MODKEY,                    XKB_KEY_Escape,         spawn,            SHCMD("noctalia-shell ipc call sessionMenu toggle") },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_l,              spawn,            SHCMD("gtklock -s $HOME/.config/gtklock/style.css -b $HOME/Pictures/matikanefuku.png") },
	...
	/* Screenshots */
	{ MODKEY,                    XKB_KEY_x,              spawn,            SHCMD("grim -g \"$(slurp)\" - | wl-copy") },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_x,              spawn,            SHCMD("grim - | wl-copy") },
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_x,              spawn,            SHCMD("grim -g \"$(slurp -o)\" - | wl-copy") },

	/* Window management */
	{ WLR_MODIFIER_CTRL|WLR_MODIFIER_ALT, XKB_KEY_q,     killclient,       {0} },
	...
	{ MODKEY,                    XKB_KEY_Tab,            togglefloating,   {0} },
	...
	{ MODKEY,                    XKB_KEY_apostrophe,  incgaps,          {.i = +5}  },
	{ MODKEY,                    XKB_KEY_semicolon,   incgaps,          {.i = -5}  },
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_apostrophe,  incigaps,         {.i = +5}  },
	{ MODKEY|WLR_MODIFIER_CTRL,  XKB_KEY_semicolon,   incigaps,         {.i = -5}  },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_apostrophe,  incogaps,         {.i = +5}  },
	{ MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_semicolon,   incogaps,         {.i = -5}  },
	...
	{ MODKEY,                    XKB_KEY_m,              shiftview,        {.i = -1} },
